...
shifter --image=nersc/fair_universe:1298f0a8 python3 $working_dir/genHEPdata/scripts/Data_merger.py --input $input_dir --output $working_dir/Delphes_PYTHIA8_output/Merged_files/$Process 

}
done

shifter --image=nersc/fair_universe:1298f0a8 python3 Final_touches.py -i /global/cfs/cdirs/m4287/hep/Delphes_PYTHIA8_output/Merged_files/ -o /global/cfs/cdirs/m4287/hep/Delphes_PYTHIA8_output --input-format "csv" --output-format "parquet"