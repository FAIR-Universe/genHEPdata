...
Systematics_path = os.path.join(os.getcwd(), "HEP-Challenge", "ingestion_program")
...
write_dir = os.path.join(parent_dir, "Datagenerator_reduced_weight")
...
def dataGenerator(verbose=0):
    ...
    if CSV:
        ...
        from_csv(full_data, os.path.join(root_dir, "input_data"))

    if PARQUET:
        # Load the data from the parquet files
        from_parquet(full_data, os.path.join(root_dir, "input_data"))
